...
public class CoblerTier1 extends Block implements ITileEntityProvider {
    ...
    public CoblerTier1(String id, CreativeTabs creativeTab, float hardness, float resistance, String harvestTool, int harvestLevel) {
        super(Material.rock);
        ...
        this.setBlockTextureName("cobblermod:t1cobbler");
    }
