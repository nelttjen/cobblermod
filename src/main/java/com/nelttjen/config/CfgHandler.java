...
public class CfgHandler {
    ...
    public static boolean createCobble;
    ...
    private static void loadConfig(){
        canShiftClick = configuration.getBoolean("canShiftClick", "I", true, "{exp} Can player ShiftRClick with empty hand to get CobbleStack from generator block");
        ...
        tier1cooldownRate = configuration.getInt("tier1cooldownTick", "I", 20, 1, 2147483647, "Tier 1 Cobbler will checks one in i tick for available inventories");
        tier2cooldownRate = configuration.getInt("tier2cooldownTick", "I", 20, 1, 2147483647, "Tier 2 Cobbler will checks one in i tick for available inventories");
        tier3cooldownRate = configuration.getInt("tier3cooldownTick", "I", 20, 1, 2147483647, "Tier 3 Cobbler will checks one in i tick for available inventories");
        tier4cooldownRate = configuration.getInt("tier4cooldownTick", "I", 20, 1, 2147483647, "Tier 4 Cobbler will checks one in i tick for available inventories");
        tier5cooldownRate = configuration.getInt("tier5cooldownTick", "I", 20, 1, 2147483647, "Tier 5 Cobbler will checks one in i tick for available inventories");
        ...
        superTierGenRate = configuration.getInt("tierSuperGenerationTick", "I", 1, 1, 2147483647,"Generation rate to i cobblestone for Tier Super Cobble Gen (in ticks)");
        superTierCooldownRate = configuration.getInt("tierSuperCooldownTick", "I", 1, 1, 2147483647, "Tier Super Cobbler will checks one in i tick for available inventories (Recommended same as \"tierSuperGenerationTick\")");
        ...
        superTierGenerate = configuration.getInt("tierSuperGenerateCobble", "I", 64, 1, 64, "How many cobblestone will Tier Super Cobbler generate in i tick");
        ...
        creativeTimeOut = configuration.getInt("creativeTimeOut", "C", 1, 1, 2147483647, "Creative generator will checks one in i tick for all available inventories and slots");

        createCobble = configuration.getBoolean("createCompressedCobble", "C", true, "Disable this to remove compressed cobble (auto removed if ExtraUtils cobble exists)");
