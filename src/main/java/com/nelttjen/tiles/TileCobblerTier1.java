...
public class TileCobblerTier1 extends TileEntity {
    ...
    public void updateEntity(){
        ...
        if (this.bufferMax != CfgHandler.tier1maxBuffer || this.generateTick != CfgHandler.tier1genRate || this.outputTimeout != CfgHandler.tier1cooldownRate){
            this.bufferMax = CfgHandler.tier1maxBuffer;
            this.generateTick = CfgHandler.tier1genRate;
            this.outputTimeout = CfgHandler.tier1cooldownRate;
        }
