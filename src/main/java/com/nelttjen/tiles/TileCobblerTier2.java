...
public class TileCobblerTier2 extends TileEntity {
    ...
    public void updateEntity(){
        ...
        if (this.bufferMax != CfgHandler.tier2maxBuffer || this.generateTick != CfgHandler.tier2genRate || this.outputTimeout != CfgHandler.tier2cooldownRate){
            this.bufferMax = CfgHandler.tier2maxBuffer;
            this.generateTick = CfgHandler.tier2genRate;
            this.outputTimeout = CfgHandler.tier2cooldownRate;
        }
