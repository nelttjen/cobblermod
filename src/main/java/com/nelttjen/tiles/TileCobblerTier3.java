...
public class TileCobblerTier3 extends TileEntity {
    ...
    public void updateEntity(){
        ...
        if (this.bufferMax != CfgHandler.tier3maxBuffer || this.generateTick != CfgHandler.tier3genRate || this.outputTimeout != CfgHandler.tier3cooldownRate){
            this.bufferMax = CfgHandler.tier3maxBuffer;
            this.generateTick = CfgHandler.tier3genRate;
            this.outputTimeout = CfgHandler.tier3cooldownRate;
        }
