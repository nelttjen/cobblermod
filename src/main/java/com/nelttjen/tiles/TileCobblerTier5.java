...
public class TileCobblerTier5 extends TileEntity {
    ...
    public void updateEntity(){
        ...
        if (this.bufferMax != CfgHandler.tier5maxBuffer || this.generateTick != CfgHandler.tier5genRate || this.outputTimeout != CfgHandler.tier5cooldownRate){
            this.bufferMax = CfgHandler.tier5maxBuffer;
            this.generateTick = CfgHandler.tier5genRate;
            this.outputTimeout = CfgHandler.tier5cooldownRate;
        }
