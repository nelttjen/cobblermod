...
public class TileCobblerTierSuper extends TileEntity {
    ...
    public void updateEntity(){
        ...
        if (this.bufferMax != CfgHandler.superTierMaxBufer || this.generateTick != CfgHandler.superTierGenRate || this.outputTimeout != CfgHandler.superTierCooldownRate || this.generate != CfgHandler.superTierGenerate){
            this.bufferMax = CfgHandler.superTierMaxBufer;
            this.generateTick = CfgHandler.superTierGenRate;
            this.outputTimeout = CfgHandler.superTierCooldownRate;
            this.generate = CfgHandler.superTierGenerate;
        ...
        if (this.count >= this.generateTick) {
            if (this.contains_cobble + this.generate < this.bufferMax) {
